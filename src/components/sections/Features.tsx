...
const Features:React.FC = () => {
  ...
  return (
     <section className="bg-black text-white cmpad mb-28">
      <div className="mx-auto">
        <h2 className="font-normal text-[64px] leading-[100%] tracking-[0] align-middle text-white/50 mb-2">
          More features
        </h2>
        ...
        <motion.h1
          ...
          className="text-3xl font-normal text-[64px] leading-[100%] tracking-[0] align-middle text-white"
        >
          {/* Highlight animation on “Promptverse AI” */}
          <motion.span
            className="font-normal text-[64px] leading-[100%] tracking-[0] align-middle text-white"
          ...
          <motion.span
            ...
            viewport={{ once: true }}
            className="font-normal text-[64px] leading-[100%] tracking-[0] align-middle text-white/50 mx-4 mb-5"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-white/20 pt-12">
          {features.map((item, idx) => (
            <div key={idx} className="space-y-3">
              <h3 className="font-medium text-[24px] leading-[32px] tracking-[-0.02em] align-middle text-white">{item.title}</h3>
              <p className="font-light text-[16px] leading-[24px] text-[#828282]">
                {item.desc}
              </p>
            </div>
          ))}
